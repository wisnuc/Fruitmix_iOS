...
#import "FMCommentHeaderView.h"
#import <QuartzCore/QuartzCore.h>
#import "UIImage+ImageEffects.h"

@interface FMCommentHeaderView ()
...
@implementation FMCommentHeaderView

+ (id)parallaxHeaderViewWithImage:(UIImage *)image forSize:(CGSize)headerSize;
{
    FMCommentHeaderView *headerView = [[FMCommentHeaderView alloc] initWithFrame:CGRectMake(0, 0, headerSize.width, headerSize.height)];
